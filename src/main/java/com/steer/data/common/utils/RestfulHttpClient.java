...
public class RestfulHttpClient {
     ...
     * @throws IOException
     */
    public static HttpResponse request(String method, String url, Object body, Map<String, String> headers)
            throws IOException {
    ...
    public static class HttpClient {
        ...
        public HttpClient method(String method) {
            ...
            // 请求方式不做限制
            // if(!ArrayUtils.contains(new String[]{METHOD_GET, METHOD_POST, METHOD_PUT,
            // METHOD_PATCH, METHOD_DELETE}, method.toUpperCase())){
        ...
        /**
         * 设置请求地址参数，替换url上的参数 如：/user/{id} 上的{id}
         */
        ...
        /**
         * 添加请求地址参数，替换url上的参数 如：/user/{id} 上的{id}
         */
    ...
    private static HttpResponse readResponse(HttpURLConnection con) throws IOException {
        try {
            ...
            br.close();
            return new HttpResponse(con.getResponseCode(), con.getHeaderFields(), con.getURL().toString(),
                    sb.toString());
        } finally {
            con.disconnect();
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        RestfulHttpClient.HttpResponse response = getClient(url).post() // 设置post请求
